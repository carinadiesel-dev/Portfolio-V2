    ...
    <footer className="w-screen pt-5 bg-cover text-ivory bg-circuitBoard">
      <div className="px-5">
        <div className="grid justify-center grid-cols-1 gap-4 px-5 md:justify-around md:grid-cols-2">
          <Typography
            variant="h3"
            className="mb-6 md:justify-self-start font-brand"
          >
            Carina Diesel
          </Typography>
        ...
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-blue-gray-50 md:flex-row md:justify-between lg:px-3">
          ...
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">Carina Diesel</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-6 py-5 md:gap-4 text-ivory sm:justify-center lg:mb-2 ">
            ...
            <Typography
              as="a"
              href="https://www.instagram.com/carinadieseldev/"
              className="transition-opacity opacity-80 hover:opacity-100"
            >
              <svg
                className="w-10 h-10 md:w-5 md:h-5"
            ...
            <Typography
              as="a"
              href="https://twitter.com/carinadieseldev"
              className="transition-opacity opacity-80 hover:opacity-100"
            >
              <svg
                className="w-10 h-10 md:w-5 md:h-5"
